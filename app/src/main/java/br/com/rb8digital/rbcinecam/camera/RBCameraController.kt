...
class RBCameraController(private val context: Context) {
    ...
    private val shutterOptions = listOf<Long?>(null, 33_333_333L, 16_666_667L, 8_333_333L, 4_000_000L)
    private val shutterLabels = listOf("AUTO", "1/30", "1/60", "1/120", "1/250")
